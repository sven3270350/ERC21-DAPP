  ...
  return (
    <div className="p-8 mt-24 flex flex-col max-w-[357px] border border-[#71717A] rounded-xl gap-4 items-center  ">
      ...
      <div className="flex-col">
        ...
        <button className="bg-[#F57C00] w-full mt-4 px-6 py-3 flex gap-2 items-center justify-center rounded-md text-[#000000] text-base font-bold leading-6 tracking-[0.032px] ">

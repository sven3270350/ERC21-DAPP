  ...
  return (
    <div className="py-3 px-4 bg-[#18181B] w-[32.5%] rounded-xl flex flex-col gap-4">
      ...
      <div className="flex justify-between">
        ...
        <button className="flex items-end" onClick={() => copyToClipboard(fundingWallet)}>
      ...
      <div className="flex justify-between pb-4">
        <div className="flex flex-col gap-2">
          <div className="flex gap-2">
            ...
            <p className="text-sm font-semibold">Admin Wallet</p>
          </div>
          <p className="text-xs font-medium text-[#71717A] tracking-[0.06px]">
            {adminWallet}
          </p>
        </div>
        <button className="flex items-end" onClick={() => copyToClipboard(adminWallet)}>
          <Image src={"/copy-01.svg"} alt="copy" width={20} height={20} />
        </button>
      </div>
      <div className="flex gap-8 pt-4">
        ...
        <div className="flex flex-col flex-1 gap-2 justify-between">
          <div className="flex gap-2">
            <Image src={"/wallet-01-white.svg"} alt="wallet" width={20} height={20} />
